...
public class ExcelTemplateService {
  ...
  public byte[] generateExampleTemplate(String type){
    ...
    switch (t){
      ...
      case "order", "orders" -> {
        headers = List.of("id", "order_number","order_reference","customer_name","customer_phone","status","assigned_agent","store_name","city_confirmed","upsell","total_price","created_at","product_summary","notes");
        types = List.of("uuid","bigint","text","text","text","text","text","text","text","boolean","numeric(12,2)","timestamp","text","text");
      }
