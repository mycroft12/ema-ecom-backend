...
public class DefaultRoleSeeder implements ApplicationRunner {
  ...
  private static final RoleDefinition SUPERVISOR_ROLE = new RoleDefinition(
      ...
      List.of(
          ...
          "orders:access:order_number",
          "orders:access:customer_name",
          "orders:access:customer_phone",
          "orders:access:status",
          "orders:access:assigned_agent",
          "orders:access:number_of_products_per_order",
          "orders:access:store_name",
          "orders:access:upsell",
          "orders:access:sku_items",
          "orders:access:city_confirmed",
          ...
          "product:access:product_variant",
          "product:access:product_link",
          "product:access:sku",
